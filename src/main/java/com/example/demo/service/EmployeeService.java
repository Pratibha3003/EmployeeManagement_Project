...
public Employee getSingleRecord(int empId) throws EmployeeNotFoundException {
...
public Employee getOneRecord(int empId) throws EmployeeNotFoundException {
	// TODO Auto-generated method stub
